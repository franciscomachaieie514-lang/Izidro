...
function scrollFix(){const h=getHistory();if(!h)return;h.style.overflowX='hidden';h.style.overflowY='hidden';h.style.display='flex';h.style.flexWrap='nowrap';h.style.gap='5px'}
